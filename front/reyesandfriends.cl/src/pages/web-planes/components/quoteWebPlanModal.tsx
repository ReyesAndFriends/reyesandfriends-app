                    ...
                    {plan ? (
                        (successMessage || errorMessage) ? (
                            <div className="flex flex-col items-center justify-center py-12">
                                <h2 className={`text-2xl font-bold mb-4 ${successMessage ? "text-green-500" : "text-red-500"}`}>
                                    {successMessage ? "¡Solicitud enviada!" : "Ocurrió un error"}
                                </h2>
                                <div className={`mb-8 text-center ${successMessage ? "text-green-400" : "text-red-400"} text-lg`}>
                                    {successMessage || errorMessage}
                                </div>
                                <button
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <form onSubmit={handleSubmit} className="space-y-3">
                                    {successMessage ? (
                                        <div className="text-green-500 text-center font-semibold py-8">{successMessage}</div>
                                    ) : (
                                        <>
                                            {errorMessage && (
                                                <div className="text-red-500 text-center font-semibold py-2">{errorMessage}</div>
                                            )}
                                            <div>
